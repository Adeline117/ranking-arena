  ...
  for (const season of seasons) {
    ...
    const scored = unique.map(t => {
      ...
      return {
        ...
        rank: 0,
        arena_score: score,
        roi: Math.max(-9999999, Math.min(9999999, t.roi ?? 0)),
        pnl: Math.max(-9999999999, Math.min(9999999999, t.pnl ?? 0)),
        max_drawdown: (t.max_drawdown != null && Math.abs(t.max_drawdown) <= 10000) ? t.max_drawdown : null,
        win_rate: wr,
