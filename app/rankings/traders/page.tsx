...
const QUICK_FILTER_EXCHANGES: { value: string; label: string; logo: string; color: string }[] = [
  { value: 'binance_futures', label: 'Binance', logo: 'https://assets.coingecko.com/markets/images/52/small/binance.jpg', color: 'var(--color-chart-amber)' },
  { value: 'bitget_futures', label: 'Bitget', logo: 'https://assets.coingecko.com/markets/images/540/small/bitget.png', color: 'var(--color-chart-teal)' },
  { value: 'okx_futures', label: 'OKX', logo: 'https://assets.coingecko.com/markets/images/96/small/WeChat_Image_20220117220452.png', color: 'var(--color-text-primary)' },
  { value: 'bybit', label: 'Bybit', logo: 'https://assets.coingecko.com/markets/images/698/small/bybit_spot.png', color: 'var(--color-chart-orange)' },
  { value: 'mexc', label: 'MEXC', logo: 'https://assets.coingecko.com/markets/images/409/small/MEXC_logo_square.jpeg', color: 'var(--color-accent-success)' },
  { value: 'htx_futures', label: 'HTX', logo: 'https://assets.coingecko.com/markets/images/25/small/logo_V_colour_black.png', color: 'var(--color-chart-indigo)' },
  { value: 'gateio', label: 'Gate.io', logo: 'https://assets.coingecko.com/markets/images/60/small/gate_io_logo1.jpg', color: 'var(--color-chart-indigo)' },
  { value: 'binance_spot', label: 'Binance', logo: 'https://assets.coingecko.com/markets/images/52/small/binance.jpg', color: 'var(--color-chart-amber)' },
  { value: 'bitget_spot', label: 'Bitget', logo: 'https://assets.coingecko.com/markets/images/540/small/bitget.png', color: 'var(--color-chart-teal)' },
  { value: 'bybit_spot', label: 'Bybit', logo: 'https://assets.coingecko.com/markets/images/698/small/bybit_spot.png', color: 'var(--color-chart-orange)' },
  { value: 'hyperliquid', label: 'Hyperliquid', logo: 'https://assets.coingecko.com/markets/images/1242/small/hyperliquid.jpeg', color: 'var(--color-chart-teal)' },
  { value: 'gmx', label: 'GMX', logo: 'https://assets.coingecko.com/markets/images/929/small/gmx.png', color: 'var(--color-chart-blue)' },
  { value: 'dydx', label: 'dYdX', logo: 'https://assets.coingecko.com/markets/images/580/small/dydx.jpg', color: 'var(--color-chart-indigo)' },
  { value: 'gains', label: 'gTrade', logo: 'https://assets.coingecko.com/markets/images/957/small/gains.jpeg', color: 'var(--color-chart-violet)' },
  { value: 'jupiter_perps', label: 'Jupiter', logo: 'https://assets.coingecko.com/markets/images/1093/small/jup.png', color: 'var(--color-accent-success)' },
  { value: 'kucoin', label: 'KuCoin', logo: 'https://assets.coingecko.com/markets/images/61/small/kucoin.png', color: 'var(--color-chart-teal)' },
  { value: 'coinex', label: 'CoinEx', logo: 'https://assets.coingecko.com/markets/images/135/small/coinex.jpg', color: 'var(--color-chart-blue)' },
  { value: 'aevo', label: 'Aevo', logo: 'https://assets.coingecko.com/markets/images/1083/small/aevo.jpeg', color: 'var(--color-chart-violet)' },
  { value: 'bingx', label: 'BingX', logo: 'https://assets.coingecko.com/markets/images/812/small/BingX_brand_logo.png', color: 'var(--color-chart-blue)' },
  { value: 'phemex', label: 'Phemex', logo: 'https://assets.coingecko.com/markets/images/380/small/phemex.png', color: 'var(--color-chart-indigo)' },
  { value: 'lbank', label: 'LBank', logo: 'https://assets.coingecko.com/markets/images/143/small/lbank.png', color: 'var(--color-chart-blue)' },
  { value: 'xt', label: 'XT.com', logo: 'https://assets.coingecko.com/markets/images/404/small/logo400x400.png', color: 'var(--color-chart-blue)' },
  { value: 'weex', label: 'WEEX', logo: 'https://assets.coingecko.com/markets/images/1013/small/weex.png', color: 'var(--color-chart-teal)' },
  { value: 'blofin', label: 'BloFin', logo: 'https://assets.coingecko.com/markets/images/1063/small/blofin.jpeg', color: 'var(--color-chart-blue)' },
  { value: 'btcc', label: 'BTCC', logo: 'https://img2.btuserlog.com/images/btcc-logo.png', color: 'var(--color-chart-blue)' },
  { value: 'bitfinex', label: 'Bitfinex', logo: 'https://assets.coingecko.com/markets/images/4/small/BFX_Logo.png', color: 'var(--color-accent-success)' },
  { value: 'okx_web3', label: 'OKX Web3', logo: 'https://assets.coingecko.com/markets/images/96/small/WeChat_Image_20220117220452.png', color: 'var(--color-text-primary)' },
  { value: 'binance_web3', label: 'Binance Web3', logo: 'https://assets.coingecko.com/markets/images/52/small/binance.jpg', color: 'var(--color-chart-amber)' },
  { value: 'toobit', label: 'Toobit', logo: 'https://assets.coingecko.com/markets/images/1040/small/toobit.jpeg', color: 'var(--color-chart-orange)' },
  { value: 'whitebit', label: 'WhiteBit', logo: 'https://assets.coingecko.com/markets/images/474/small/whitebit.png', color: 'var(--color-chart-teal)' },
]
