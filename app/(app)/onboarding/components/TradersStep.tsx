...
export default function TradersStep({
  theme,
  language: _language,
  traders,
  followedTraders,
              ...
              >
                ...
                <Box
                  style={{
                    ...
                    flexShrink: 0,
                    background:
                      'linear-gradient(135deg, var(--color-accent-primary-30), var(--color-pro-gold-glow))',
                    display: 'flex',
                    alignItems: 'center',
                ...
                <Box style={{ flex: 1, minWidth: 0 }}>
                  ...
                  <Text size="xs" style={{ color: theme.textSecondary }}>
                    {t.arena_score != null
                      ? `${tr('scoreLabel')} ${t.arena_score.toFixed(0)}`
                      : t.source}
                  </Text>
                </Box>
                <button
                  className="follow-btn"
                  onClick={() => onFollowTrader(tid)}
                  style={{
