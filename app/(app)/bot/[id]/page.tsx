      ...
      <div className="max-w-4xl mx-auto px-4 py-6" style={{ paddingBottom: 80 }}>
          ...
          <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
              ...
              <StatCard
                ...
                value={
                  snap.max_drawdown != null ? `-${Number(snap.max_drawdown).toFixed(1)}%` : '—'
                }
        ...
        {snapshots.length > 1 && (
          <>
            ...
            >
              <div
                className="grid grid-cols-4 gap-2 px-4 py-3 text-xs font-semibold border-b"
                style={{
                  color: 'var(--color-text-tertiary)',
              ...
              {snapshots.map((s: Record<string, unknown>) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      color:
                        ((s.apy as number) ?? (s.roi as number) ?? 0) >= 0
                          ? 'var(--color-accent-success)'
                          : 'var(--color-accent-error)',
                    }}
                  >
                    {s.apy != null
                      ? formatPercent(s.apy as number)
                      : s.roi != null
                        ? formatPercent(s.roi as number)
                        : '—'}
                  </div>
                  <div
