          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: tokens.spacing[5] }}>
            <div
              style={{
                ...
                height: 64,
                borderRadius: tokens.radius.xl,
                background: `linear-gradient(135deg, ${alpha(info.colorHex, 13)}, ${alpha(info.colorHex, 27)})`,
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                <span>
                  ...
                  {info.nextExp ? ` / ${info.nextExp.toLocaleString('en-US')}` : ''}
                </span>
                <span
                  style={{
              ...
              <div
                ...
                style={{
                  ...
                  background: isCurrent
                    ? `linear-gradient(135deg, ${alpha(lvl.colorHex, 9)}, ${alpha(lvl.colorHex, 3)})`
                ...
                >
                  <span
                    style={{
                      ...
                      background: `${alpha(lvl.colorHex, 13)}`,
                      color: lvl.colorHex,
                      fontWeight: tokens.typography.fontWeight.bold,
                      fontSize: tokens.typography.fontSize.sm,
                      flexShrink: 0,
