  ...
  return (
    <>
      ...
      >
        {/* Back button */}
        <Link
          href="/inbox?tab=messages&chat=direct"
          style={{
                  ...
                  {otherPresence && (
                    <Box
                      style={{
                        ...
                        height: 12,
                        borderRadius: tokens.radius.full,
                        background: otherPresence.isOnline
                  ...
                  {!remark && otherPresence && (
                    ...
                    >
                      {otherPresence.isOnline
                        ? t('onlineNow')
                        : formatLastSeen(otherPresence.lastSeenAt, t)}
                    </Text>
                  )}
          ...
          <>
              ...
              onClick={() =>
                window.dispatchEvent(
                  new CustomEvent('startCall', {
                    detail: { targetUserId: otherUser.id, callType: 'voice' },
                  })
                )
              }
              title={t('voiceCall')}
            ...
            <HeaderButton
              onClick={() =>
                window.dispatchEvent(
                  new CustomEvent('startCall', {
                    detail: { targetUserId: otherUser.id, callType: 'video' },
                  })
                )
              }
              title={t('videoCall')}
