                    ...
                    >
                      <span
                        style={{
                          ...
                          borderRadius: '50%',
                          flexShrink: 0,
                          background: comment.author_avatar_url
                            ? undefined
                            : getAvatarGradient(comment.user_id || comment.author_handle),
                          display: 'flex',
                          alignItems: 'center',
                      ...
                      >
                        {comment.author_avatar_url ? (
                          <Image
                            ...
                            alt={comment.author_handle || 'User avatar'}
                            fill
                            sizes="24px"
                          ...
                          <span
                            style={{ color: tokens.colors.white, fontSize: 10, fontWeight: 700 }}
                          >
                ...
                >
                  {(expandedReplies[comment.id]
                    ...
                    <Box key={reply.id} style={{ padding: `${tokens.spacing[1]} 0` }}>
                          ...
                          >
                            <span
                              style={{
                                ...
                                borderRadius: '50%',
                                flexShrink: 0,
                                background: reply.author_avatar_url
                                  ? undefined
                                  : getAvatarGradient(reply.user_id || reply.author_handle),
                                display: 'flex',
                                alignItems: 'center',
                                justifyContent: 'center',
                                overflow: 'hidden',
                            ...
                            >
                              {reply.author_avatar_url ? (
                                <Image
                                  ...
                                  alt={reply.author_handle || 'User avatar'}
                                  fill
                                  sizes="20px"
                                  style={{ objectFit: 'cover' }}
                                />
                      ...
                      <Text size="xs" style={{ marginLeft: tokens.spacing[1] }}>
                        {reply.content}
                      </Text>
                    </Box>
                  ))}
