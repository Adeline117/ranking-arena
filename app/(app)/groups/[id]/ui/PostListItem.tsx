...
export default function PostListItem(props: PostListItemProps) {
  ...
  const contentToShow =
    isExpanded || !isLongContent ? displayContent : displayContent.slice(0, 150) + '...'
        ...
        >
          <Box style={{ display: 'flex', alignItems: 'center', gap: tokens.spacing[2] }}>
            ...
            <Text size="xs" color="tertiary" style={{ marginLeft: tokens.spacing[1] }}>
              · {formatTimeAgo(post.created_at, language as 'en' | 'zh' | 'ja' | 'ko')}
            </Text>
          </Box>

          {/* Admin actions */}
          <Box
            style={{ display: 'flex', alignItems: 'center', gap: tokens.spacing[1], flexShrink: 0 }}
          >
            {post.is_pinned && (
              <span
                style={{
                  fontSize: 11,
                  fontWeight: 700,
                  color: tokens.colors.accent?.primary || ARENA_PURPLE,
                  ...
                  <button
                    ...
                    style={{
                      ...
                      color: post.is_pinned
                        ? tokens.colors.accent?.primary || ARENA_PURPLE
        ...
        >
          ...
          <Button
            ...
            style={{
              padding: 0,
              minWidth: 'auto',
              color: post.user_bookmarked ? 'var(--color-accent-warning)' : undefined,
            }}
