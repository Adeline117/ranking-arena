...
import type { SessionInfo, BlockedUserInfo, InitialValues, TouchedFields } from '../types'
import type { SectionId } from '../components'

export function useSettingsState(activeSection: SectionId) {
    ...
    try {
      ...
      if (initialValuesRef.current) {
        ...
        if (camelKey in initialValuesRef.current) {
          (initialValuesRef.current as unknown as Record<string, unknown>)[camelKey] = value
        }
      }
  ...
  return {
    ...
    // Save
    handleSaveProfile, hasUnsavedChanges, handleDiscardChanges,
    // Security
    newEmail, setNewEmail, savingEmail, handleChangeEmail,
    currentPassword, setCurrentPassword,
    newPassword, setNewPassword,
    confirmNewPassword, setConfirmNewPassword,
    savingPassword, handleChangePassword,
    passwordResetMode, setPasswordResetMode,
    resetCodeSent, sendingResetCode, resetCountdown, handleSendResetCode,
    // 2FA
    ...
    handleRevokeSession, handleRevokeAllSessions,
    // Notifications
    ...
    emailDigest, handleEmailDigestChange,
    ...
    blockedUsers, loadingBlockedUsers, unblockingId, handleUnblock,
    // Account
    isPro, handleLogout,
    showDeleteAccountModal, setShowDeleteAccountModal,
    deletePassword, setDeletePassword,
    deleteReason, setDeleteReason,
    deleteError, deletingAccount, handleDeleteAccount,
    // Utilities
    showToast, showConfirm, t, router,
  }
}
