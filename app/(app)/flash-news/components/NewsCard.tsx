    ...
    >
      <Box
        ...
        style={{
          ...
          border: `2.5px solid ${tokens.colors.bg.primary}`,
          boxShadow: `0 0 8px ${alpha(impConfig.color, 38)}`,
      ...
      <Box style={{ flex: 1 }}>
        ...
        >
          ...
          <Box style={{ paddingTop: item.importance !== 'normal' ? tokens.spacing[4] : '0' }}>
            ...
            >
              <Text
                style={{ color: tokens.colors.text.tertiary, fontSize: '14px', fontWeight: '500' }}
              >
            ...
            {content && (
              <Text
                style={{
                  color: translatedContent[item.id]
