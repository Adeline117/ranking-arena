...
.ssr-hdr{display:grid;grid-template-columns:40px 1fr 60px 80px 60px 60px;padding:10px 16px;font-size:11px;font-weight:600;color:var(--color-text-tertiary);border-bottom:1px solid var(--color-border-primary);gap:8px}
.ssr-row{display:grid;grid-template-columns:40px 1fr 60px 80px 60px 60px;padding:10px 16px;gap:8px;align-items:center;text-decoration:none;color:inherit;border-bottom:1px solid var(--color-border-primary);min-height:52px}
...
.ssr-score{text-align:right;font-size:13px;font-weight:700}
...
.ssr-wr{text-align:right;font-size:12px;color:var(--color-text-secondary)}
.ssr-mdd{text-align:right;font-size:12px;color:var(--color-danger)}
