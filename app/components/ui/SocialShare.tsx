    ...
    <div className={`relative ${className}`}>
      ...
      {showDropdown && (
        <>
          ...
          />
          <div
            className="absolute right-0 top-full mt-2 w-48 bg-[var(--color-bg-secondary)] border border-[var(--color-border-primary)] rounded-xl shadow-xl overflow-hidden z-50"
            role="menu"
            aria-label="分享选项"
          >
            <div className="p-2">
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-2 bg-[var(--color-bg-secondary)] rounded-lg p-2">
            <label className="sr-only" htmlFor="invite-url">邀请链接</label>
            <input
              id="invite-url"
              type="text"
              value={inviteUrl}
