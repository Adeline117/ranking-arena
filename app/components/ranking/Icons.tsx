...
export const FilterIcon = memo(function FilterIcon({ size = 14 }: { size?: number }) {
  return (
...
export const CompareIcon = memo(function CompareIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const SortIndicator = memo(function SortIndicator({ active, dir }: { active: boolean; dir: 'asc' | 'desc' }) {
  return (
    <svg
      width={8}
      height={10}
...
export const LockIconSmall = memo(function LockIconSmall({ size = 10 }: { size?: number }) {
  return (
...
export const SearchIcon = memo(function SearchIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const TableViewIcon = memo(function TableViewIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const CardViewIcon = memo(function CardViewIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const SettingsIcon = memo(function SettingsIcon({ size = 14 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
