...
export const SortIndicator = ({ active, dir }: { active: boolean; dir: 'asc' | 'desc' }) => (
  <svg
    width={8}
    height={10}
    viewBox="0 0 8 10"
...
export const LockIconSmall = ({ size = 10 }: { size?: number }) => (
...
export const TableViewIcon = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const CardViewIcon = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
...
export const SettingsIcon = ({ size = 14 }: { size?: number }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
