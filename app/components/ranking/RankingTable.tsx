        ...
        {viewMode === 'table' && (
          ...
          >
            ...
            <Box
              ...
              aria-pressed={sortColumn === 'winrate'}
              data-sortable
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            {visibleColumns.includes('sortino') && (
              <Box
                ...
                aria-pressed={sortColumn === 'sortino'}
                data-sortable
                style={{
                  display: 'flex',
                  alignItems: 'center',
