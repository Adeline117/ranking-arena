      ...
      {simulation && (
        ...
        >
          ...
          >
            ...
            >
              $
              {simulation.finalValue.toLocaleString('en-US', {
            ...
            >
              {isPositive ? '+' : ''}
              {simulation.profit.toLocaleString('en-US', {
                minimumFractionDigits: 2,
                maximumFractionDigits: 2,
              })}{' '}
              ({isPositive ? '+' : ''}
              {simulation.returnPct.toFixed(1)}%)
            </span>
          </div>
        </div>
      )}
        ...
        >
          ...
          <defs>
            <linearGradient id="simGradient" x1="0" y1="0" x2="0" y2="1">
              <stop
                offset="0%"
                stopColor={isPositive ? 'rgba(47, 229, 125, 0.3)' : 'rgba(255, 124, 124, 0.3)'}
              />
