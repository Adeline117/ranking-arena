...
const STYLE_CONFIGS: Record<TradingStyle, StyleConfig> = {
  ...
  conservative: {
    ...
    color: 'var(--color-chart-teal)',
    bgColor: 'var(--color-accent-success-10)',
    description: 'Low-risk approach with tight drawdown control',
    descriptionZh: '低风险偏好，回撤控制严格',
  },
  balanced: {
    label: 'Balanced',
    labelZh: '均衡',
    ...
    description: 'Balanced risk/return profile across market conditions',
    descriptionZh: '风险收益均衡，风格适中',
  },
  aggressive: {
    label: 'Aggressive',
    labelZh: '激进',
    color: 'var(--color-accent-error)',
    bgColor: 'var(--color-accent-error-10)',
    description: 'High-risk high-reward with large position swings',
    descriptionZh: '高风险高收益，仓位波动大',
  },
  unknown: {
    label: 'Unknown',
    labelZh: '未知',
      ...
      {showConfidence && confidence !== null && (
        <Box
          style={{
            ...
            marginLeft: 2,
            padding: '2px 6px',
            background: colorAlpha(tokens.colors.bg.primary, 50),
            borderRadius: tokens.radius.full,
          }}
        >
    ...
    return (
      <Box
        style={{
          ...
          background: colorAlpha(tokens.colors.bg.tertiary, 25),
