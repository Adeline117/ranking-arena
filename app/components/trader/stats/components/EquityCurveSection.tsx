    ...
    return (
      ...
      >
        ...
        <svg
          ...
          viewBox="0 0 56 44"
          fill="none"
          style={{ opacity: 0.25, color: 'var(--color-text-tertiary)' }}
        >
        ...
        <Text
          size="xs"
          color="tertiary"
          style={{ textAlign: 'center', maxWidth: 280, lineHeight: 1.6, opacity: 0.8 }}
        >
      ...
      {hasData && currentData.length <= 3 ? (
        <Box
          style={{
            ...
            justifyContent: 'center',
            gap: tokens.spacing[3],
            background: `${alpha(tokens.colors.bg.tertiary, 25)}`,
            borderRadius: tokens.radius.xl,
            padding: tokens.spacing[6],
          }}
        >
          ...
          >
            <path
              d="M10 6h20M10 34h20M12 6c0 8 8 12 8 14S12 26 12 34M28 6c0 8-8 12-8 14s8 6 8 14"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <Text
            size="sm"
            color="tertiary"
            style={{ textAlign: 'center', maxWidth: 300, lineHeight: 1.6 }}
          >
          ...
          >
            {currentData
              .map(
                (d) =>
                  `${new Date(d.date).toLocaleDateString('en-US')}: ${chartType === 'roi' ? d.roi.toFixed(2) + '%' : '$' + d.pnl.toLocaleString('en-US')}`
              )
              .join('  |  ')}
          </Text>
        </Box>
