    ...
    <>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', gap: 10, marginTop: 8 }}>
        <div
          style={{
            ...
            lineHeight: 1.25,
            color:
              !showingOriginal && translatedListPosts[openPost.id]?.title
        ...
        <AvatarLink
          handle={openPost.author_handle}
          avatarUrl={openPost.author_avatar_url}
          isPro={openPost.author_is_pro}
          showProBadge={openPost.author_show_pro_badge}
        />
      </div>
      ...
      <div
        ...
        style={{
          ...
          color:
            !showingOriginal && translatedContent
              ? tokens.colors.accent.translated
              : tokens.colors.text.primary,
          lineHeight: 1.7,
          whiteSpace: 'pre-wrap',
      ...
      {openPost.original_post && (
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
            ...
            <AvatarLink
              handle={openPost.original_post.author_handle}
              avatarUrl={openPost.original_post.author_avatar_url}
              isPro={openPost.original_post.author_is_pro}
              showProBadge={openPost.original_post.author_show_pro_badge}
            />
          </div>
      ...
      {openPost.poll_id && (
        <CustomPollCard
          ...
          onSelectOption={(index) => {
            if (customPoll?.type === 'single') setSelectedPollOptions([index])
            else
      ...
      <PostDetailActions
        ...
        onOpenBookmarkFolder={onOpenBookmarkFolder}
        onRepost={onRepost}
        showToast={showToast}
        t={t}
      />
