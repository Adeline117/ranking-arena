      ...
      >
        ...
        >
          ...
          <AvatarLink
            ...
            isPro={p.author_is_pro}
            showProBadge={p.author_show_pro_badge}
            isOfficial={p.author_handle === 'arena_bot'}
          />
        </div>
          ...
          {currentUserId && p.author_id === currentUserId && (
            <span style={{ display: 'flex', gap: 8, marginLeft: 'auto' }}>
              <button
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.color = p.is_pinned
                    ? ARENA_PURPLE
                    : tokens.colors.text.tertiary
                  e.currentTarget.style.background = p.is_pinned
