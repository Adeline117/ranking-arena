...
const TYPES: Record<string, {
  ...
  copycat:    { name: 'The Copycat',    nameZh: '跟单达人',   color: '#EC4899', gradient: 'linear-gradient(135deg, #EC4899 0%, #F43F5E 100%)', master: 'Peter Lynch',       masterZh: 'Peter Lynch',       tagline: 'Learn from the best, profit with the rest', taglineZh: '跟随高手，复制成功',     style: 'Copy Trading',         styleZh: '跟单交易',     risk: 3, horizon: 'Medium',   horizonZh: '中线' },
  tourist:    { name: 'The Tourist',    nameZh: '币圈游客',   color: '#F59E0B', gradient: 'linear-gradient(135deg, #F59E0B 0%, #D97706 100%)', master: 'Your Coworker',     masterZh: '你的同事',           tagline: 'Trust me bro, this one is going to the moon', taglineZh: '相信我兄弟，这个要上月球了', style: 'Vibes-Based Investing', styleZh: '凭感觉投资',  risk: 3, horizon: 'Short',    horizonZh: '短线' },
  paperhands: { name: 'The Paper Hands',nameZh: '纸手',       color: '#94A3B8', gradient: 'linear-gradient(135deg, #94A3B8 0%, #64748B 100%)', master: 'Everyone Who Sold BTC Under $1,000', masterZh: '所有在$1,000以下卖出BTC的人', tagline: 'I will buy back in when it dips', taglineZh: '等它回调我就买回来', style: 'Panic-Driven Exit Strategy', styleZh: '恐慌驱动的退出策略', risk: 1, horizon: 'Short', horizonZh: '短线' },
  narrator:   { name: 'The Narrator',   nameZh: '叙事者',     color: '#F43F5E', gradient: 'linear-gradient(135deg, #F43F5E 0%, #EF4444 100%)', master: 'Cathie Wood',       masterZh: 'Cathie Wood',       tagline: 'The story drives the trade',               taglineZh: '故事驱动交易',           style: 'Narrative Trading',    styleZh: '叙事交易',     risk: 4, horizon: 'Long',     horizonZh: '长线' },
}
