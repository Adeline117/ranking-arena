...
const TYPES: Record<string, {
  ...
  arbitrageur:{ name: 'The Arbitrageur',nameZh: '套利者',     color: '#14B8A6', gradient: 'linear-gradient(135deg, #14B8A6 0%, #06B6D4 100%)', master: 'Ed Thorp',          masterZh: 'Ed Thorp',          tagline: 'Risk-free profit is the purest alpha',     taglineZh: '无风险利润是最纯粹的 Alpha', style: 'Arbitrage',          styleZh: '套利交易',     risk: 1, horizon: 'Short',    horizonZh: '短线' },
  gridbot:    { name: 'The Grid Bot',   nameZh: '网格机器人', color: '#A855F7', gradient: 'linear-gradient(135deg, #A855F7 0%, #7C3AED 100%)', master: 'James Simons',      masterZh: 'James Simons',      tagline: 'Systematic execution beats emotion',       taglineZh: '系统化执行胜过情绪',     style: 'Grid Trading',         styleZh: '网格交易',     risk: 2, horizon: 'Medium',   horizonZh: '中线' },
