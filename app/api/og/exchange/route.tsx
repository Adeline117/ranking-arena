...
async function fetchExchangeData(
  exchange: string
): Promise<{ traders: TopTrader[]; total: number }> {
...
export async function GET(request: NextRequest) {
  try {
    ...
    const displayName =
      PLATFORM_NAMES[exchange] ||
      exchange.replace(/_/g, ' ').replace(/\b\w/g, (c) => c.toUpperCase())
      ...
      >
        <div
          style={{
            ...
            width: 600,
            height: 600,
            background: `radial-gradient(circle, ${platformColor}15 0%, transparent 70%)`,
            display: 'flex',
          }}
        />
        <div
        ...
        <div
          style={{
            ...
            right: 0,
            height: 4,
            background: `linear-gradient(90deg, ${platformColor} 0%, ${C.purple} 50%, ${platformColor} 100%)`,
            display: 'flex',
          }}
        />
        ...
        >
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, marginBottom: 32 }}>
            ...
            >
              <span style={{ fontSize: 24, fontWeight: 900, color: platformColor }}>
                {displayName.charAt(0)}
              </span>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 6 }}>
              <span
                style={{ fontSize: 42, fontWeight: 900, color: C.white, letterSpacing: '-1px' }}
              >
                {displayName} Rankings
              </span>
              <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                <span style={{ fontSize: 16, color: C.dim }}>
                  {total > 0 ? total.toLocaleString('en-US') : '0'} ranked traders
                </span>
                <div
                  style={{
                    display: 'flex',
                ...
                >
                  ...
                  />
                  <span style={{ fontSize: 12, fontWeight: 700, color: platformColor }}>
                    {displayName}
                  </span>
                </div>
              </div>
                ...
                return (
                  ...
                  >
                    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                      ...
                      >
                        <span style={{ fontSize: 14, fontWeight: 900, color: medalColor }}>
                          {i + 1}
                        </span>
                      </div>
                      {avatarSrc ? (
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
                      ...
                      >
                        {trader.arena_score != null
                          ? Math.round(trader.arena_score).toString()
                          : '--'}
                      </span>
                    </div>
                    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          >
            <span style={{ fontSize: 14, color: C.dim }}>
              Crypto Trader Rankings across 45+ exchanges
            </span>
