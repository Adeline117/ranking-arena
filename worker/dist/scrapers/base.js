 ...
 */
export function parseTraderFromApi(item, rank) {
    const traderId = String(item.portfolioId || item.encryptedUid || item.leadPortfolioId || item.uid || '');
    if (!traderId)
        return null;
