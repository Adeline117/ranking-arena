...
export const STICKERS: Sticker[] = [
  ...
  { id: 'bearish', name_en: 'Bearish', name_zh: '看跌', label_en: 'Bearish', label_zh: '看跌', path: '/stickers/bearish.png' },
  { id: 'mooning', name_en: 'Mooning', name_zh: '登月', label_en: 'To the Moon', label_zh: '登月', path: '/stickers/mooning.png' },
  { id: 'happy', name_en: 'Happy', name_zh: '开心', label_en: 'Happy', label_zh: '开心', path: '/stickers/happy.png' },
  { id: 'daze', name_en: 'Daze', name_zh: '发呆', label_en: 'Daze', label_zh: '发呆', path: '/stickers/daze.png' },
  { id: 'hodl', name_en: 'HODL', name_zh: 'HODL', label_en: 'Hold On for Dear Life', label_zh: '坚定持有', path: '/stickers/hodl.png' },
  { id: 'diamond_hands', name_en: 'Diamond Hands', name_zh: '钻石手', label_en: 'Diamond Hands', label_zh: '钻石手', path: '/stickers/diamond_hands.png' },
  { id: 'fomo', name_en: 'FOMO', name_zh: 'FOMO', label_en: 'Fear of Missing Out', label_zh: '怕错过', path: '/stickers/fomo.png' },
  { id: 'gm', name_en: 'GM', name_zh: '早安', label_en: 'Good Morning', label_zh: '早安', path: '/stickers/gm.png' },
  ...
  { id: 'crying', name_en: 'Crying', name_zh: '哭泣', label_en: 'Crying', label_zh: '哭泣', path: '/stickers/crying.png' },
]
