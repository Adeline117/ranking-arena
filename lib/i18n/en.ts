...
const en = {
  ...
  adminScraperStale: 'Stale (≥8h default)',
  adminScraperCritical: 'Critical (≥24h default)',
  ...
  adminFreshDesc: 'Oldest 7D/30D/90D watermark is below its source-specific stale threshold',
  adminStaleDesc: 'Oldest watermark is at or above stale, but below critical',
  adminCriticalDesc: 'Oldest watermark is at or above the source-specific critical threshold',
  adminUnknownDesc: 'Registry visibility or watermark authority failed closed',
  adminThresholdOverrides:
    'Defaults are 8h stale / 24h critical; the server applies audited source-specific overrides.',
  adminFreshnessLoadError:
    'Could not refresh the freshness report. The last verified report is preserved.',
  adminFreshnessPermissionError:
    'Admin session verification failed. Sign in again before retrying.',
  adminFreshnessInvalidResponse:
    'The freshness response failed contract validation. The last verified report is preserved.',
