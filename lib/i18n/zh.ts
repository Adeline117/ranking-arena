...
const zh = {
  ...
  walletSection: '钱包管理',
  walletDescription: '连接和管理你的 Web3 钱包，查看链上 NFT 徽章。',
  ...
  adminScraperStale: '陈旧（默认 ≥8 小时）',
  adminScraperCritical: '严重（默认 ≥24 小时）',
  ...
  adminStaleCount: '陈旧（默认 ≥{threshold} 小时）: {count}',
  adminCriticalCount: '严重（默认 ≥{threshold} 小时）: {count}',
  adminUnknownCount: '权威未知: {count}',
  ...
  adminLastUpdate: '最老上游水位: {time}',
  adminAgeHours: '距今: {hours} 小时',
  adminRecordCount: '各周期可见行数合计: {count}',
  adminCheckedAt: '检查时间: {time}',
  adminStatusExplanation: '状态说明',
  adminFreshDesc: '7D/30D/90D 中最老水位仍低于该来源的陈旧阈值',
  adminStaleDesc: '最老水位已达到陈旧阈值，但尚未达到严重阈值',
  adminCriticalDesc: '最老水位已达到该来源的严重阈值',
  adminUnknownDesc: 'Registry 可见性或水位权威异常，系统已失败关闭',
  adminThresholdOverrides: '默认阈值为陈旧 8 小时、严重 24 小时；服务端会应用已审计的来源级覆盖。',
  adminFreshnessLoadError: '无法刷新新鲜度报告，已保留上一次通过校验的报告。',
  adminFreshnessPermissionError: '管理员会话校验失败，请重新登录后再试。',
  adminFreshnessInvalidResponse: '新鲜度响应未通过契约校验，已保留上一次可信报告。',
  adminNoVerifiedFreshness: '当前没有通过校验的新鲜度报告。',
  adminScraperAlertA11y: '有 {count} 个来源或检查需要处理',
  ...
  walletUnlinkConfirm: '确定要解绑钱包吗？链上 NFT 徽章将不再显示，但不会改变您的套餐权益。',
  ...
  expirationDate: '到期日期',
  nextRenewal: '下次续费',
  nftMembershipCard: 'NFT 链上徽章',
  nftValidUntil: '有效期至:',
  nftNotMintedPro: '您是 Pro 会员，但尚未铸造 NFT 徽章。',
  nftLinkWalletHint: '链接钱包后将自动铸造 NFT 徽章。',
  nftLinkWallet: '链接钱包',
  nftUpgradeHint: '升级 Pro 会员后可获得 NFT 徽章。',
