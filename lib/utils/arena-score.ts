...
export const ARENA_V4_CONFIG = {
  // 权重(owner 2026-07-08 定稿,回测校准 + 取 0.05 整数倍):赚钱 0.50 + 实力 0.50。
  // 回测(trader_series 30d 前瞻)证明过去 ROI/PnL 不预测未来收益(均值回归),
  // 故赚钱封顶 0.50:PnL 0.30(防刷锚+Arena 身份,领头)+ ROI 0.20(跟单者回报)。
  // 实力 0.50:回撤 0.20 + Sharpe 0.20(两个稳健风险维度)+ 一致性 0.10(目前仅胜率/盈利
  // 因子代理,尚无真时间一致性,故最低)。
  W: { pnl: 0.3, roi: 0.2, dd: 0.2, sharpe: 0.2, con: 0.1 },
