...
export function getCopyTradeUrl(
  ...
  const urlMap: Record<string, string> = {
    ...
    bybit_spot: `https://www.bybit.com/copyTrade/trade-center/detail?leaderMark=${traderId}`,
    ...
    okx_futures: `https://www.okx.com/copy-trading/trader/${traderId}`,
    okx_spot: `https://www.okx.com/copy-trading/trader/${traderId}`,
    okx_web3: `https://www.okx.com/web3/dex/portfolio/${traderId}`,
