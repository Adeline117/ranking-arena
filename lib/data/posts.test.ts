...
describe('getPostById', () => {
  test('should return null when post not found', async () => {
    ...
    const result = await getPostById(mockSupabase as any, 'nonexistent')
  ...
  test('should throw error on database error', async () => {
    ...
    await expect(getPostById(mockSupabase as any, 'post1')).rejects.toThrow()
  })
})
...
describe('createPost', () => {
  test('should create a new post', async () => {
    ...
    const result = await createPost(mockSupabase as any, 'user1', 'testUser', {
      title: 'New Post',
      content: 'New content',
    })
  ...
  test('should throw error on creation failure', async () => {
    ...
    await expect(
      createPost(mockSupabase as any, 'user1', 'testUser', { title: 'Test', content: 'Test' })
    ).rejects.toThrow()
  })
})
...
describe('updatePost', () => {
  test('should update an existing post', async () => {
    ...
    const result = await updatePost(mockSupabase as any, 'post1', 'user1', {
      title: 'Updated Title',
    })
  ...
  test('should throw error on update failure', async () => {
    ...
    await expect(
      updatePost(mockSupabase as any, 'post1', 'user1', { title: 'Test' })
    ).rejects.toThrow()
  })
})
...
describe('incrementViewCount', () => {
  test('should call rpc to increment view count', async () => {
    ...
    await incrementViewCount(mockSupabase as any, 'post1')
...
describe('getUserPostReaction', () => {
  test('should return null when no reaction found', async () => {
    ...
    const result = await getUserPostReaction(mockSupabase as any, 'post1', 'user1')
    expect(result).toBeNull()
  })
...
describe('getUserPostVote', () => {
  test('should return null when no vote found', async () => {
    ...
    const result = await getUserPostVote(mockSupabase as any, 'post1', 'user1')
    expect(result).toBeNull()
  })
...
describe('getUserPostReactions', () => {
  test('should return map of user reactions', async () => {
    ...
    const result = await getUserPostReactions(mockSupabase as any, ['post1', 'post2'], 'user1')
...
describe('getUserPostVotes', () => {
  test('should return map of user votes', async () => {
    ...
    const result = await getUserPostVotes(mockSupabase as any, ['post1', 'post2'], 'user1')
