...
export const EXCHANGE_CONFIG: Record<TraderSource, ExchangeConfig> = {
  ...
  drift: { name: 'Drift', sourceType: 'web3', reliability: 80, trustWeight: 0.9, roiType: 'mixed' },
  paradex: {
    name: 'Paradex',
    sourceType: 'web3',
    reliability: 80,
  ...
  aevo: { name: 'Aevo', sourceType: 'web3', reliability: 85, trustWeight: 0.9, roiType: 'mixed' },
  perpetual_protocol: {
